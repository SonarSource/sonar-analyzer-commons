...
```bash
sonar analyze agentic --project SonarSource_sonar-analyzer-commons --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project SonarSource_sonar-analyzer-commons --depth DEEP
```
