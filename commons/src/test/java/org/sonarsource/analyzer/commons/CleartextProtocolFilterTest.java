...
public class CleartextProtocolFilterTest {
  ...
  @Test
  public void localhost_is_safe() throws Exception {
  ...
  @Test
  public void ipv4_loopback_is_safe() throws Exception {
  ...
  @Test
  public void ipv6_loopback_is_safe() throws Exception {
  ...
  @Test
  public void aws_imds_ipv4_is_safe() throws Exception {
  ...
  @Test
  public void aws_imds_ipv6_is_safe() throws Exception {
    assertThat(CleartextProtocolFilter.isSafe("http://[fd00:ec2::254]/latest/meta-data/")).isTrue();
  }

  @Test
  public void gcp_imds_hostname_is_safe() throws Exception {
  ...
  @Test
  public void docker_internal_hostnames_are_safe() throws Exception {
  ...
  @Test
  public void kubernetes_cluster_local_dns_is_safe() throws Exception {
  ...
  @Test
  public void bind_all_address_is_safe() throws Exception {
    assertThat(CleartextProtocolFilter.isSafe("http://0.0.0.0:8080")).isTrue();
  }

  @Test
  public void aspnet_listen_wildcard_is_safe() throws Exception {
  ...
  @Test
  public void w3c_namespace_uris_are_safe() throws Exception {
  ...
  @Test
  public void android_namespace_uri_is_safe() throws Exception {
    assertThat(CleartextProtocolFilter.isSafe("http://schemas.android.com/apk/res/android")).isTrue();
  }

  @Test
  public void soap_namespace_uri_is_safe() throws Exception {
    assertThat(CleartextProtocolFilter.isSafe("http://schemas.xmlsoap.org/soap/envelope/")).isTrue();
  }

  @Test
  public void other_well_known_namespace_uris_are_safe() throws Exception {
  ...
  @Test
  public void matching_is_case_insensitive() throws Exception {
  ...
  @Test
  public void surrounding_whitespace_is_stripped() throws Exception {
    assertThat(CleartextProtocolFilter.isSafe("  http://localhost  ")).isTrue();
    assertThat(CleartextProtocolFilter.isSafe("  http://example.com  ")).isFalse();
  }
}
